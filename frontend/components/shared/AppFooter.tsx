...
import { CounselorTab } from '@/components/counselor/CounselorNavbar';
      ...
      >
        ...
        <div className="flex justify-end pt-2">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 bg-[#059669] hover:bg-[#047857] text-white font-['Inter'] text-xs font-semibold rounded-lg transition-colors border-0 cursor-pointer shadow-xs"
          >
            Đã hiểu
          </button>
        </div>
