...
export default function GapView() {
  return <section className="app-view buddy-landing" id="view-gap"><div className="gap-detail-workspace">
    <header className="gap-detail-hero"><h2>Kết quả Match <span>chi tiết</span></h2><span id="gap-detail-context">Chọn một kết quả Match để xem bằng chứng, điểm mạnh và các điểm cần làm rõ.</span></header>
