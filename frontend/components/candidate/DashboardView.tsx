...
export default function DashboardView({ isActive = false }: { isActive?: boolean }) {
  ...
  return (
    <section
      ref={rootRef}
      className={`app-view dashboard-dashboard home-dashboard ${isActive ? 'active' : ''}`}
      id="view-dashboard"
    >
      {/* ── 1. HERO SECTION ── */}
      ...
      <section id="features" className="home-features-suite" aria-labelledby="features-suite-title">
      ...
      <section id="for-you" className="home-about-showcase" aria-labelledby="about-showcase-title">
      ...
      <section id="how-it-works" className="home-pipeline-section" aria-labelledby="pipeline-title">
      ...
      <footer id="contact" className="home-main-footer" aria-labelledby="footer-title">
