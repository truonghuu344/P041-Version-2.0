      ...
      <section className="home-features-suite" aria-labelledby="features-suite-title">
        <div className="features-suite-inner">
          <header className="features-suite-header" data-reveal="fade-up">
            ...
            <p>
              Khám phá 3 giải pháp trọng tâm được thiết kế chuyên biệt để nâng tầm sự nghiệp của
              bạn.
            </p>
          </header>
          ...
          <div className="features-bento-grid">
            ...
            >
              ...
              <div className="bento-card-body">
                ...
                <p>
                  Chuyển hóa từng dòng mô tả thành câu thành tích định lượng theo mô hình STAR, tối
                  ưu từ khóa ngành nghề giúp CV nổi bật trước hệ thống ATS.
                </p>
                <div className="bento-cv-preview-box">
                  ...
                  <div className="preview-diff-line after">
                    ...
                    <strong>
                      Tối ưu hóa kiến trúc Backend microservices, nâng cao 40% throughput và giảm
                      25% độ trễ API.
                    </strong>
                  </div>
                </div>
            ...
            >
              ...
              <div className="bento-card-body">
                ...
                <p>
                  Đối chiếu chi tiết 100% yêu cầu JD, phát hiện chính xác lỗ hổng kỹ năng còn thiếu
                  và nhận kế hoạch hành động P1–P3 tức thì.
                </p>
            ...
            >
              ...
              <div className="bento-card-body">
                ...
                <p>
                  Thực hành tương tác trực tiếp bằng giọng nói với AI Coach. Nhận báo cáo phân tích
                  độ tự tin, cấu trúc ý tưởng và phản xạ chuyên môn.
                </p>
      ...
      <section className="home-about-showcase" aria-labelledby="about-showcase-title">
        <div className="about-showcase-inner">
          <div className="about-story-col" data-reveal="fade-right">
            ...
            <h2 id="about-showcase-title">Nâng Tầm Sự Nghiệp Với Trợ Lý AI Đa Tác Tử Tiên Phong</h2>
            <p className="about-story-p">
              Career Assistant ra đời với sứ mệnh xóa bỏ rào cản ứng tuyển cho sinh viên và người
              tìm việc tại Việt Nam. Chúng tôi kết hợp sức mạnh của hệ thống AI Đa Tác Tử
              (Multi-Agent) và chuẩn đánh giá tuyển dụng quốc tế, đem đến giải pháp chuẩn bị sự
              nghiệp khách quan, thực chiến và chính xác nhất.
            </p>
            ...
            <div className="about-highlights-list">
              <div className="highlight-item">
                ...
                <div>
                  ...
                  <span>
                    Mọi điểm số và lời khuyên đều gắn liền với bằng chứng xác thực trong CV.
                  </span>
                </div>
              </div>
              ...
              <div className="highlight-item">
                ...
                <div>
                  ...
                  <span>
                    Không dùng mẫu chung chung, tối ưu hóa độc bản cho từng vị trí bạn ứng tuyển.
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="about-matrix-col" data-reveal="fade-left">
            <div className="matrix-card card-emerald">
              ...
              <p>
                Đánh giá dựa trên văn bản thực tế trong hồ sơ, mang lại kết quả chuẩn xác tuyệt đối.
              </p>
            </div>
            ...
            <div className="matrix-card card-purple">
              ...
              <p>
                Chuyển đổi kinh nghiệm thành câu từ ấn tượng, đạt điểm cao nhất khi qua hệ thống
                quét tự động.
              </p>
            </div>
            ...
            <div className="matrix-card card-teal">
              ...
              <p>
                Tương tác 1-1 trực tiếp với AI Coach, rèn luyện phản xạ và nhận góp ý cải thiện chi
                tiết.
              </p>
            </div>
            ...
            <div className="matrix-card card-amber">
              ...
              <p>
                Hồ sơ cá nhân luôn thuộc quyền kiểm soát của bạn, tuân thủ nghiêm ngặt chuẩn bảo
                mật.
              </p>
            </div>
          </div>
      ...
      <section className="home-pipeline-section" aria-labelledby="pipeline-title">
        <div className="home-pipeline-inner">
          <header className="pipeline-header" data-reveal="fade-up">
            ...
            <p>
              Chỉ với 3 bước đơn giản để biến hồ sơ của bạn thành tấm vé vàng chinh phục nhà tuyển
              dụng.
            </p>
          </header>
          ...
          <div className="pipeline-track">
            ...
            >
              ...
              <div className="pipeline-content-card">
                ...
                <p>
                  Tải lên file CV (PDF/DOCX) và dán nội dung JD vị trí mong muốn hoặc chọn từ kho
                  việc làm hàng đầu.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="pipeline-content-card highlight-node">
                ...
                <p>
                  AI Agent phân tích khoảng cách kỹ năng (Gap Analysis), đề xuất viết lại câu chuẩn
                  STAR và xuất bản PDF ATS.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="pipeline-content-card">
                ...
                <p>
                  Luyện tập đối đáp phỏng vấn bằng giọng nói với AI Coach, tự tin thể hiện bản thân
                  và nắm chắc việc làm mơ ước.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="footer-top-grid" data-reveal="fade-up">
            <div className="footer-col brand-col">
              ...
              <div className="footer-social-links" aria-label="Mạng xã hội">
                <a href="#facebook" className="social-pill" aria-label="Facebook">
                  Facebook
                </a>
                <a href="#linkedin" className="social-pill" aria-label="LinkedIn">
                  LinkedIn
                </a>
                <a href="#github" className="social-pill" aria-label="GitHub">
                  GitHub
                </a>
                <a href="#youtube" className="social-pill" aria-label="YouTube">
                  YouTube
                </a>
              </div>
            </div>
            ...
            <div className="footer-col">
              ...
              <ul className="footer-nav-list">
                <li>
                  <button type="button" onClick={() => goTo('nav-cv')}>
                    Tối ưu hóa CV chuẩn ATS
                  </button>
                </li>
                <li>
                  <button type="button" onClick={() => goTo('nav-match', 'nav-gap')}>
                    So khớp CV với JD
                  </button>
                </li>
                <li>
                  <button type="button" onClick={() => goTo('nav-interview')}>
                    Luyện phỏng vấn Voice AI
                  </button>
                </li>
                <li>
                  <button type="button" onClick={() => goTo('nav-find-jobs')}>
                    Tìm kiếm việc làm phù hợp
                  </button>
                </li>
                <li>
                  <button type="button" onClick={() => goTo('nav-cv')}>
                    Bộ sưu tập mẫu CV đẹp
                  </button>
                </li>
              </ul>
            </div>
            ...
            <div className="footer-col">
              ...
              <ul className="footer-nav-list">
                <li>
                  <a href="#about-showcase-title">Giới thiệu về chúng tôi</a>
                </li>
                <li>
                  <a href="#pipeline-title">Lộ trình 3 bước</a>
                </li>
                <li>
                  <a href="#partners">Dành cho Nhà tuyển dụng</a>
                </li>
                <li>
                  <a href="#counselors">Dành cho Cố vấn nghề nghiệp</a>
                </li>
                <li>
