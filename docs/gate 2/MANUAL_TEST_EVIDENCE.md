...
```text
python -m pytest -q
336 passed, 6 skipped in 137.39s (0:02:17)
...
| **README & Setup Guide** | [`README.md`](file:///d:/AITHUCCHIEN/PROJECT/P-041/README.md) đầy đủ biến môi trường, hướng dẫn cài đặt và sample queries | **Đạt** |
...
| **MVP Demo Video** | Thư mục `presentation/` | Chuẩn bị ghi hình |
